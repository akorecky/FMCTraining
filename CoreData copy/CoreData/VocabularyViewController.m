...
-(void) fetchVocabularies {
    NSFetchRequest *request = [NSFetchRequest fetchRequestWithEntityName:@"Vocabulary"];
...
-(void) add {
    UIAlertView *inputAlert = [[UIAlertView alloc] initWithTitle:@"New Vocabulary" message:@"Enter new Language/Vocabulary" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Okay", nil];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        NSManagedObject *remove = [self.fetchedResultController objectAtIndexPath:indexPath];
        ...
        if (! success) {
            NSLog(@"Object Not Removed! Reason: %@", error);
        }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    Vocabulary *vocabulary = (Vocabulary *) [self.fetchedResultController objectAtIndexPath:indexPath];
